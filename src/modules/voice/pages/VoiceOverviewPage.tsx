...
export function VoiceOverviewPage() {
  return (
    <div className="flex flex-col gap-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-text">Voice Agents Overview</h1>
          <p className="text-muted text-sm mt-1">Manage your voice settings and data here.</p>
        </div>
        <Button>
